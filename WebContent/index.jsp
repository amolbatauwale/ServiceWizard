...
<body>
    <div class="page-wrapper bg-gra-01 p-t-180 p-b-100 font-poppins">
        <div class="wrapper wrapper--w780">
            <div class="">
              <center>
                            <button class="btn btn--pill btn--green" type="button" onclick="window:location='loginuser.jsp'" >User Login</button>
                            <button class="btn btn--pill btn--green" type="button" onclick="window:location='adminlogin.jsp'">Admin Login</button>
                        </center>
